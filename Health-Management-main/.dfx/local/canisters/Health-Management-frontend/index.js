...
import { idlFactory } from './Health-Management-frontend.did.js';
export { idlFactory } from './Health-Management-frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_HEALTH_MANAGEMENT_FRONTEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./Health-Management-frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the Health-Management-frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./Health-Management-frontend.did.js")._SERVICE>}
 */
export const Health_Management_frontend = createActor(canisterId);

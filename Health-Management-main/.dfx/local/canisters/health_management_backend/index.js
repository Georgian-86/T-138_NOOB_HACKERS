...
import { idlFactory } from './health_management_backend.did.js';
export { idlFactory } from './health_management_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_HEALTH_MANAGEMENT_BACKEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./health_management_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the health_management_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./health_management_backend.did.js")._SERVICE>}
 */
export const health_management_backend = createActor(canisterId);
